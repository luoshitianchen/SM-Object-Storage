...
DESCRIPTION = "企业对象存储中心：文件、附件、归档和备份对象管理"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="数据平台部", max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "数据平台部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
