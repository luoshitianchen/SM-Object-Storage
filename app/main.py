...
VERSION = "1.0.0"
SERVICE_NAME = "sm-object-storage"
DISPLAY_NAME = "SM Object Storage"
DESCRIPTION = "对象存储服务：桶、对象、上传下载与生命周期管理"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="基础架构部", min_length=1, max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "基础架构部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
